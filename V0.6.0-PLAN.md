...
### Week 2: Content + GIFs
1. [ ] Generate all Getting Started GIFs (VHS tool)
2. [ ] Generate Intermediate GIFs
3. [ ] Generate Advanced GIFs
4. [ ] Create REFCARD-TUTORIALS.md
5. [ ] Embed diagrams in tutorial spec

### Week 3: Advanced + Polish
1. [ ] Update mkdocs.yml navigation for tutorials
2. [ ] Create `docs/tutorials/` structure
3. [ ] User testing with 3-5 people
4. [ ] Add more tests (target: 40+)

### Week 4: Integration + Release
1. [ ] Add `/craft:docs:tutorial` command to craft
