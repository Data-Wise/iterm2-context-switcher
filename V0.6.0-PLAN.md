...
5. [ ] Create `src/aiterm/utils/tutorial.py` skeleton

### Week 2: Content + GIFs
6. [ ] Implement Getting Started tutorial (7 steps)
7. [ ] Generate all Getting Started GIFs
8. [ ] Implement Intermediate tutorial (11 steps)
9. [ ] Generate Intermediate GIFs
10. [ ] Integrate `ait learn` command

### Week 3: Advanced + Polish
11. [ ] Implement Advanced tutorial (13 steps)
12. [ ] Generate Advanced GIFs
13. [ ] Create REFCARD-TUTORIALS.md
14. [ ] Add 40+ tests
15. [ ] Update mkdocs.yml navigation

### Week 4: Integration + Release
16. [ ] Add `/craft:docs:tutorial` command to craft
17. [ ] User testing with 3-5 people
18. [ ] Documentation polish
19. [ ] Release as v0.6.0
